...
import { AnAtmInterface } from './../../services/an-atm.service';

@Component({
    selector: 'sb-an-atm',
    templateUrl: './an-atm.component.html',
    styleUrls: ['an-atm.component.scss'],
})
export class AnAtmComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnAtmInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'atm/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Atm.xlsx');
            })
    }
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'atm/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'atm/find-all',
