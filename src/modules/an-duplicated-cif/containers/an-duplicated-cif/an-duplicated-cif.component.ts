...
import { AnDuplicatedCifInterface } from './../../services/an-duplicated-cif.service';

@Component({
    selector: 'sb-an-duplicated-cif',
    templateUrl: './an-duplicated-cif.component.html',
    styleUrls: ['an-duplicated-cif.component.scss'],
})
export class AnDuplicatedCifComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnDuplicatedCifInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'duplicated-cif/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Duplicate CIF.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'duplicated-cif/find-all',
            ...
            columns: [{ data: 'noIdentitas' }, { data: 'cif' }],
        };
