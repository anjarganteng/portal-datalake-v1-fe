...
import { AnIrrevocableLcInterface } from './../../services/an-irrevocable-lc.service';

@Component({
    selector: 'sb-an-irrevocable-lc',
    templateUrl: './an-irrevocable-lc.component.html',
    styleUrls: ['an-irrevocable-lc.component.scss'],
})
export class AnIrrevocableLcComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnIrrevocableLcInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'irrevocable-lc/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'IRREVOCABLE LC.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'irrevocable-lc/find-all',
            ...
            columns: [{ data: 'embedIrrevocableLc.customerNo' }, { data: 'embedIrrevocableLc.accountNo' }],
        };
