...
import { AnBankGuaranteeInterface } from './../../services/an-bank-guarantee.service';

@Component({
    selector: 'sb-an-bank-guarantee',
    templateUrl: './an-bank-guarantee.component.html',
    styleUrls: ['an-bank-guarantee.component.scss'],
})
export class AnBankGuaranteeComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnBankGuaranteeInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'bank-guarantee/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'BANK GUARANTEE.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'bank-guarantee/find-all',
            ...
            columns: [{ data: 'embedBankGuarantee.customerNo' }, { data: 'embedBankGuarantee.accountNo' }],
        };
