...
import { AnFraudnasabahInterface } from './../../services/an-fraudnasabah.service';

@Component({
    selector: 'sb-an-fraudnasabah',
    templateUrl: './an-fraudnasabah.component.html',
    styleUrls: ['an-fraudnasabah.component.scss'],
})
export class AnFraudnasabahComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnFraudnasabahInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'fraudnasabah/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Fraudnasabah.xlsx');
            })
    }
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'fraudnasabah/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'fraudnasabah/find-all',
