...
import { AnBilyetInterface } from './../../services/an-bilyet.service';

@Component({
    selector: 'sb-an-bilyet',
    templateUrl: './an-bilyet.component.html',
    styleUrls: ['an-bilyet.component.scss'],
})
export class AnBilyetComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnBilyetInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'bilyet/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Bilyet.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'bilyet/find-all',
            ...
            columns: [{ data: 'checkNo' }, { data: 'applicantCustomerNo' }],
        };
