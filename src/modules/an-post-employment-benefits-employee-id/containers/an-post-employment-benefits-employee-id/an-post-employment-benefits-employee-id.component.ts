...
import { AnPostEmploymentBenefitsEmployeeIdInterface } from './../../services/an-post-employment-benefits-employee-id.service';

@Component({
    selector: 'sb-an-post-employment-benefits-employee-id',
    templateUrl: './an-post-employment-benefits-employee-id.component.html',
    styleUrls: ['an-post-employment-benefits-employee-id.component.scss'],
})
export class AnPostEmploymentBenefitsEmployeeIdComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnPostEmploymentBenefitsEmployeeIdInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'post-employment-benefits-employee-id/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Key Management Personal - Post Employment Benefits EmployeeId.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'post-employment-benefits-employee-id/find-all',
