...
import { AnPihakterkaitInterface } from './../../services/an-pihakterkait.service';

@Component({
    selector: 'sb-an-pihakterkait',
    templateUrl: './an-pihakterkait.component.html',
    styleUrls: ['an-pihakterkait.component.scss'],
})
export class AnPihakterkaitComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnPihakterkaitInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'pihak-terkait/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Pihak Terkait.xlsx');
            })
    }
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'pihak-terkait/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'pihak-terkait/find-all',
