...
import { AnOtherBenefitsPaidInterface } from './../../services/an-other-benefits-paid.service';

@Component({
    selector: 'sb-an-other-benefits-paid',
    templateUrl: './an-other-benefits-paid.component.html',
    styleUrls: ['an-other-benefits-paid.component.scss'],
})
export class AnOtherBenefitsPaidComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnOtherBenefitsPaidInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'other-benefits-paid/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Key Management Personal - Other Benefits Paid.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'other-benefits-paid/find-all',
