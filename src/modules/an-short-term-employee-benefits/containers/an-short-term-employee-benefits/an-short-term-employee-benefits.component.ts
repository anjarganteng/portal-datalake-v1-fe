...
import { AnShortTermEmployeeBenefitsInterface } from './../../services/an-short-term-employee-benefits.service';

@Component({
    selector: 'sb-an-short-term-employee-benefits',
    templateUrl: './an-short-term-employee-benefits.component.html',
    styleUrls: ['an-short-term-employee-benefits.component.scss'],
})
export class AnShortTermEmployeeBenefitsComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnShortTermEmployeeBenefitsInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'short-term-employee-benefits/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Key Management Personal - Short Term Employee Benefits.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'short-term-employee-benefits/find-all',
