...
import { AnDeferredTaxInterface } from './../../services/an-deferred-tax.service';

@Component({
    selector: 'sb-an-deferred-tax',
    templateUrl: './an-deferred-tax.component.html',
    styleUrls: ['an-deferred-tax.component.scss'],
})
export class AnDeferredTaxComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnDeferredTaxInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'deferred-tax/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'DEFERRED TAX.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'deferred-tax/find-all',
            ...
            columns: [{ data: 'embedDeferredTax.code' }, { data: 'embedDeferredTax.groupCode' }],
        };
