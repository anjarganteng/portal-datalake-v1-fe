...
import { AnValidationLogInterface } from './../../services/an-validation-log.service';

@Component({
    selector: 'sb-an-validation-log',
    templateUrl: './an-validation-log.component.html',
    styleUrls: ['an-validation-log.component.scss'],
})
export class AnValidationLogComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnValidationLogInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'validation-log/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Validation Log.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'validation-log/find-all',
            ...
            columns: [{ data: 'columnName' }, { data: 'rowNumber' }],
        };
