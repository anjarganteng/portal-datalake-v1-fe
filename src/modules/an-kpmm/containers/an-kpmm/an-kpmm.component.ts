...
import { AnKpmmInterface } from './../../services/an-kpmm.service';

@Component({
    selector: 'sb-an-kpmm',
    templateUrl: './an-kpmm.component.html',
    styleUrls: ['an-kpmm.component.scss'],
})
export class AnKpmmComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnKpmmInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'kpmm/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'KPMM.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'kpmm/find-all',
            ...
            columns: [{ data: 'embedKpmm.kodeForm' }, { data: 'embedKpmm.kodeKomponen' }],
        };
