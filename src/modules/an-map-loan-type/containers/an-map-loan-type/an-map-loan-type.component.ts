...
import { AnMapLoanTypeInterface } from './../../services/an-map-loan-type.service';

@Component({
    selector: 'sb-an-map-loan-type',
    templateUrl: './an-map-loan-type.component.html',
    styleUrls: ['an-map-loan-type.component.scss'],
})
export class AnMapLoanTypeComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnMapLoanTypeInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'map-loan-type/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'MAP LOAN TYPE.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'map-loan-type/find-all',
            ...
            columns: [{ data: 'embedMapLoanType.loanType' }, { data: 'embedMapLoanType.bmiProduct' }],
        };
