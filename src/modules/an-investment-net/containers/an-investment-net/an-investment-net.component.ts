...
import { AnInvestmentNetInterface } from './../../services/an-investment-net.service';

@Component({
    selector: 'sb-an-investment-net',
    templateUrl: './an-investment-net.component.html',
    styleUrls: ['an-investment-net.component.scss'],
})
export class AnInvestmentNetComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnInvestmentNetInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'investment-net/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'INVESTMENT NET.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'investment-net/find-all',
