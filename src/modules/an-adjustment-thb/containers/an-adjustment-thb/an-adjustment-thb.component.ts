...
import { AnAdjustmentThbInterface } from './../../services/an-adjustment-thb.service';

@Component({
    selector: 'sb-an-adjustment-thb',
    templateUrl: './an-adjustment-thb.component.html',
    styleUrls: ['an-adjustment-thb.component.scss'],
})
export class AnAdjustmentThbComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnAdjustmentThbInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'adjustment-thb/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Adjustment THB.xlsx');
            })
    }	
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'adjustment-thb/find-all',
