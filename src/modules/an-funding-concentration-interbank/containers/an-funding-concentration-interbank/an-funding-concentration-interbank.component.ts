...
import { AnFundingConcentrationInterbankInterface } from './../../services/an-funding-concentration-interbank.service';

@Component({
    selector: 'sb-an-funding-concentration-interbank',
    templateUrl: './an-funding-concentration-interbank.component.html',
    styleUrls: ['an-funding-concentration-interbank.component.scss'],
})
export class AnFundingConcentrationInterbankComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnFundingConcentrationInterbankInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'funding-concentration-interbank/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Funding Concentration Interbank.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'funding-concentration-interbank/find-all',
