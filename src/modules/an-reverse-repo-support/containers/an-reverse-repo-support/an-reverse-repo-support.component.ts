...
import { AnReverseRepoSupportInterface } from './../../services/an-reverse-repo-support.service';

@Component({
    selector: 'sb-an-reverse-repo-support',
    templateUrl: './an-reverse-repo-support.component.html',
    styleUrls: ['an-reverse-repo-support.component.scss'],
})
export class AnReverseRepoSupportComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnReverseRepoSupportInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'reverse-repo-support/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Reverse Repo Support.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'reverse-repo-support/find-all',
            ...
            columns: [{ data: 'underlyingNo' }, { data: 'publicationDate' }],
        };
