...
import { AnCifToFiInterface } from './../../services/an-cif-to-fi.service';

@Component({
    selector: 'sb-an-cif-to-fi',
    templateUrl: './an-cif-to-fi.component.html',
    styleUrls: ['an-cif-to-fi.component.scss'],
})
export class AnCifToFiComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnCifToFiInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'cif-to-fi/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'CIF TO FI.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'cif-to-fi/find-all',
            ...
            columns: [{ data: 'embedCifToFi.cifNo' }, { data: 'embedCifToFi.flag' }],
        };
