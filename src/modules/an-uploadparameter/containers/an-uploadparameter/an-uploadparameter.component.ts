...
import { AnUploadparameterInterface } from './../../services/an-uploadparameter.service';

@Component({
    selector: 'sb-an-uploadparameter',
    templateUrl: './an-uploadparameter.component.html',
    styleUrls: ['an-uploadparameter.component.scss'],
})
export class AnUploadparameterComponent implements  AfterViewInit, OnDestroy, OnInit {
    form: FormGroup | undefined;
    ModelInterface: Observable<AnUploadparameterInterface> | undefined;
    ...
    getData(data: any, isEdit = false) {
        this.Api.get(this.Api.URLServiceAntasena + 'list-menu/get-all?form=' + "parameter").subscribe(
            dataResult => {
                this.dataData = [];
                let lastData;
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'upload-parameter/save-excel', 
                    formData
                ).subscribe(
                    data => {
                        if (data.status) {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'upload-parameter/find-all-parameter',
            ...
            columns: [{ data: 'fileName' }, { data: 'inputDate' }, { data: 'inputTime' }, { data: 'status' }],
