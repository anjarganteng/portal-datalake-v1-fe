...
import { AnProsesUmumInterface } from './../../services/an-proses-umum.service';

@Component({
    selector: 'sb-an-proses-umum',
    templateUrl: './an-proses-umum.component.html',
    styleUrls: ['an-proses-umum.component.scss'],
})
export class AnProsesUmumComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnProsesUmumInterface> | undefined;
    ...
    regenerateData() {
        if (confirm('Are you sure you want to do this?')) {
            this.Api.post(
                ...
                'datawarehouse_GL_NG',
                {
                    namaProses: 'datawarehouse_GL_NG'
                }
                ).subscribe(
                    data => {
                        if (data.status) {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'manual-trigger/find-all',
