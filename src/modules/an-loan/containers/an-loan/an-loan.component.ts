...
import { AnLoanInterface } from './../../services/an-loan.service';

@Component({
    selector: 'sb-an-loan',
    templateUrl: './an-loan.component.html',
    styleUrls: ['an-loan.component.scss'],
})
export class AnLoanComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnLoanInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'loan/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Loan.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'loan/find-all',
            ...
            columns: [{ data: 'embedLoan.customerNo' }, { data: 'embedLoan.loanNo' }],
        };
