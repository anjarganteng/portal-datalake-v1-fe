...
import { AnIntercompanyTransactionKbankInterface } from './../../services/an-intercompany-transaction-kbank.service';

@Component({
    selector: 'sb-an-intercompany-transaction-kbank',
    templateUrl: './an-intercompany-transaction-kbank.component.html',
    styleUrls: ['an-intercompany-transaction-kbank.component.scss'],
})
export class AnIntercompanyTransactionKbankComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnIntercompanyTransactionKbankInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'intercompany-transaction-kbank/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'INTERCOMPANY TRANSACTION KBANK.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'intercompany-transaction-kbank/find-all',
            ...
            columns: [{ data: 'embedIntercompanyTransactionKbank.accountType' }, { data: 'embedIntercompanyTransactionKbank.accountNo' }],
        };
