...
import { AnHapusbukuInterface } from './../../services/an-hapusbuku.service';

@Component({
    selector: 'sb-an-hapusbuku',
    templateUrl: './an-hapusbuku.component.html',
    styleUrls: ['an-hapusbuku.component.scss'],
})
export class AnHapusbukuComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnHapusbukuInterface> | undefined;
    ...
    ngOnInit(): void {
        this.form = this.formBuilder.group({
            ...
            rupiah: ['', Validators.required],
            valas: ['', Validators.required],
            new: [],
        });
        this.dEdit = {
            sandiAntasena: '',
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'hapus-buku/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Hapus Buku.xlsx');
            })
    }
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'hapus-buku/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'hapus-buku/find-all',
