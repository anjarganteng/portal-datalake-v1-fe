...
import { AnCoaBotInterface } from './../../services/an-coa-bot.service';

@Component({
    selector: 'sb-an-coa-bot',
    templateUrl: './an-coa-bot.component.html',
    styleUrls: ['an-coa-bot.component.scss'],
})
export class AnCoaBotComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnCoaBotInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'coa-bot/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'COA BOT.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'coa-bot/find-all',
            ...
            columns: [{ data: 'embedCoaBot.glCode' }, { data: 'embedCoaBot.currency' }],
        };
