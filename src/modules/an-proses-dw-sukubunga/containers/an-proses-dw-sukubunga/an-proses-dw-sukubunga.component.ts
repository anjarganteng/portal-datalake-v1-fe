...
import { AnProsesDwSukubungaInterface } from './../../services/an-proses-dw-sukubunga.service';

@Component({
    selector: 'sb-an-proses-dw-sukubunga',
    templateUrl: './an-proses-dw-sukubunga.component.html',
    styleUrls: ['an-proses-dw-sukubunga.component.scss'],
})
export class AnProsesDwSukubungaComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnProsesDwSukubungaInterface> | undefined;
    ...
    regenerateData() {
        if (confirm('Are you sure you want to do this?')) {
            this.Api.post(
                this.Api.URLServiceAntasena + 'proses-dw-sukubunga/process?namaProses=' +
                'datawarehouse_SukuBunga_NG',
                {
                    namaProses: 'datawarehouse_SukuBunga_NG'
                }
                ).subscribe(
                    data => {
                        if (data.status) {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'proses-dw-sukubunga/find-all',
