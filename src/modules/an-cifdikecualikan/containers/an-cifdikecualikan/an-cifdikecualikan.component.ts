...
import { AnCifdikecualikanInterface } from './../../services/an-cifdikecualikan.service';

@Component({
    selector: 'sb-an-cifdikecualikan',
    templateUrl: './an-cifdikecualikan.component.html',
    styleUrls: ['an-cifdikecualikan.component.scss'],
})
export class AnCifdikecualikanComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnCifdikecualikanInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'cif-dikecualikan/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Cif Dikecualikan.xlsx');
            })
    }
    ...
    showEdit(data: any) {
        ...
        this.Api.get(
            this.Api.URLServiceAntasena + 
                'cif-dikecualikan/find-by-id?id=' + 
                data.noCif
            ...
            .result.then(
                result => {
                    ...
                    if (this.closeResult == 'dodelete') {
                        ...
                        this.Api.post(
                            this.Api.URLServiceAntasena +
                                'cif-dikecualikan/delete-by-id?id=' +
                                data.noCif,
                            {
                                noCif: data.noCif,
                            }
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'cif-dikecualikan/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'cif-dikecualikan/find-all',
