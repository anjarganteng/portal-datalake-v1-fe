...
import { AnRegeneratelogInterface } from './../../services/an-regeneratelog.service';

@Component({
    selector: 'sb-an-regeneratelog',
    templateUrl: './an-regeneratelog.component.html',
    styleUrls: ['an-regeneratelog.component.scss'],
})
export class AnRegeneratelogComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnRegeneratelogInterface> | undefined;
    ...
    //     this.Api.get(
    //         this.Api.URLService + 'MODULEURL/find-by-id?id=' + data.id
    ...
    //             }
    //             this.Api.post(this.Api.URLService + 'MODULEURL/save', this.form.value).subscribe(
    //                 data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'regenerate-log/find-all',
            ...
            columns: [{ data: 'processDate' }, { data: 'processTime'}, {data: 'formName'}],
        };
