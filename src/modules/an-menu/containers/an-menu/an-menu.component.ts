...
import { AnMenuInterface } from './../../services/an-menu.service';

@Component({
    selector: 'sb-an-menu',
    templateUrl: './an-menu.component.html',
    styleUrls: ['an-menu.component.scss'],
})
export class AnMenuComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnMenuInterface> | undefined;
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'list-menu/save', 
                    this.form.value
                ).subscribe(
                    data => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'list-menu/find-all',
