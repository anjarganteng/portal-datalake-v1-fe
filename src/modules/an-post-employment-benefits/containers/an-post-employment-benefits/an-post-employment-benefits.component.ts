...
import { AnPostEmploymentBenefitsInterface } from './../../services/an-post-employment-benefits.service';

@Component({
    selector: 'sb-an-post-employment-benefits',
    templateUrl: './an-post-employment-benefits.component.html',
    styleUrls: ['an-post-employment-benefits.component.scss'],
})
export class AnPostEmploymentBenefitsComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnPostEmploymentBenefitsInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'post-employment-benefits/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Key Management Personal - Post Employment Benefits.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'post-employment-benefits/find-all',
