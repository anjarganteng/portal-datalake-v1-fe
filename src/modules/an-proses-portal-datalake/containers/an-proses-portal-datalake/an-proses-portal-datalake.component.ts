...
import { AnProsesPortalDatalakeInterface } from './../../services/an-proses-portal-datalake.service';

@Component({
    selector: 'sb-an-proses-portal-datalake',
    templateUrl: './an-proses-portal-datalake.component.html',
    styleUrls: ['an-proses-portal-datalake.component.scss'],
})
export class AnProsesPortalDatalakeComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnProsesPortalDatalakeInterface> | undefined;
    ...
    regenerateData() {
        if (confirm('Are you sure you want to do this?')) {
            this.Api.post(
                this.Api.URLServiceAntasena + 'proses-portal-datalake/process?namaProses=' +
                'portal_datalake_NG',
                {
                    namaProses: 'portal_datalake_NG'
                }
                ).subscribe(
                    data => {
                        if (data.status) {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'proses-portal-datalake/find-all',
