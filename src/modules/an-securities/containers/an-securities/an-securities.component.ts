...
import { AnSecuritiesInterface } from './../../services/an-securities.service';

@Component({
    selector: 'sb-an-securities',
    templateUrl: './an-securities.component.html',
    styleUrls: ['an-securities.component.scss'],
})
export class AnSecuritiesComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnSecuritiesInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'securities/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'SECURITIES.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'securities/find-all',
