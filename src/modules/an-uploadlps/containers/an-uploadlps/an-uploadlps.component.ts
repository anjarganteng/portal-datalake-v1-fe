...
import { AnUploadlpsInterface } from './../../services/an-uploadlps.service';

@Component({
    selector: 'sb-an-uploadlps',
    templateUrl: './an-uploadlps.component.html',
    styleUrls: ['an-uploadlps.component.scss'],
})
export class AnUploadlpsComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnUploadlpsInterface> | undefined;
    ...
    getData(data: any, isEdit = false) {
        this.Api.get(this.Api.URLServiceAntasena + 'list-menu/get-all?form=' + "lps").subscribe(
            dataResult => {
                this.dataData = [];
                let lastData;
    ...
    submit() {
        if (this.form) {
            if (this.form.valid) {
                ...
                this.Api.post(
                    this.Api.URLServiceAntasena + 'upload-lps/save-excel', 
                    formData
                ).subscribe(
                    data => {
                        if (data.status) {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'upload-lps/find-all-lps',
