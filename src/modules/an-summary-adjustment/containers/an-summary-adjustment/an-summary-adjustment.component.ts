...
import { AnSummaryAdjustmentInterface } from './../../services/an-summary-adjustment.service';

@Component({
    selector: 'sb-an-summary-adjustment',
    templateUrl: './an-summary-adjustment.component.html',
    styleUrls: ['an-summary-adjustment.component.scss'],
})
export class AnSummaryAdjustmentComponent implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<AnSummaryAdjustmentInterface> | undefined;
    ...
    getExcelData() {
        this.http.get(this.Api.URLServiceAntasena + 'summary-adjustment/download', { responseType: 'blob' })
            .subscribe((res: any) => {
                saveAs(res, 'Summary Adjustment.xlsx');
            })
    }
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLServiceAntasena + 'summary-adjustment/find-all',
            ...
            columns: [{ data: 'adjustmentNo' }, { data: 'coa' }],
        };
