...
import { <%= classify(name) %>Interface } from './../../services/<%= dasherize(name) %>.service';
...
export class <%= classify(name) %>Component implements  AfterViewInit, OnDestroy, OnInit {
   form: FormGroup | undefined;
    ModelInterface: Observable<<%= classify(name) %>Interface> | undefined;
    ...
    getData(data: any) {
        this.Api.get(this.Api.URLService + 'MODULEURL/get-all').subscribe(
            dataResult => {
        ...
        that.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                this.Api.loadDataTable(
                    this.Api.URLService + 'MODULEURL/find-all',
                    dataTablesParameters
                ).subscribe((resp: { data: any; recodsTotal: any; recordsFiltered: any }) => {
